...
public class PrintData {
    ...
    // args[1] <-- The name of the file to write the JSON output
    ...
    // args[3] <-- The value to be looked up.
        if (args.length != 5) {
            ...
            convertTSV(args[0], args[1], args[2], args[3], Integer.parseInt(args[4]));
        }
    }
	...
	try {
        ...
        // following is true.
        //
        // Ticket padding above = 0 lines
        // Ticket body          = 15 lines
        // Ticket padding below = 4 lines
        //
